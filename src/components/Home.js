...
import product1 from '../assets/textiles images.jpg';  
import product2 from '../assets/polyester.webp';  
import product3 from '../assets/chiffon.jpg'; 
    ...
    <div className="home-container">
      ...
      <section className="hero-section" style={{ backgroundImage: `url(${heroImage})` }}>
        <div className="hero-content">
          ...
          <p style={{ color: 'black' }}> Discover the finest fabrics and accessories</p>
